...
%     \hbox
%     {%
%     \begin{beamercolorbox}[wd=.3\paperwidth,center]{title in head/foot}
%     \usebeamerfont{title in head/foot}\insertshorttitle\hspace*{0em}
%     \end{beamercolorbox}
%     
%     \begin{beamercolorbox}[wd=.4\paperwidth,center]{author in head/foot}%
%     \usebeamerfont{author in head/foot}\insertshortauthor
%     \end{beamercolorbox}
%     
%     \begin{beamercolorbox}[wd=.3\paperwidth,center]{page of total}
...
% \makeatletter
% footline color
\setbeamercolor{title in head/foot}{fg=black, bg=mygrey!20!white}
\setbeamercolor{author in head/foot}{fg=black, bg=mygrey!5!white}
\setbeamercolor{page of total}{fg=black, bg=mygrey!20!white}
...
\def\TmpCode{\DejaVu\scriptsize}
\def\Ncode#1{{\TmpCode{#1}}}
\def\Pcode#1{\text{\TmpCode{ #1 }}}
\def\Fcode#1{\text{\TmpCode{#1}}}
